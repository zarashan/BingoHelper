...
public class BingoItem
{
    ...
    [JsonIgnore] private static int[] SizeTypes = new int[]
    {
    ...
    {
        switch ((CollectionType) Rand.Next(SizeTypes[0]))
        {
        ...
        return CreateBingoItem("I Broke Sorry");
    }


    public static BingoItem GenerateWierd(Random Rand)
    {
        switch ((WierdType) Rand.Next(SizeTypes[1]))
        {
    ...
    {
        switch ((KillType) Rand.Next(SizeTypes[2]))
        {
    ...
    {
        switch ((SceneType) Rand.Next(SizeTypes[3]))
        {
            ...
            case SceneType.OpenBossDoor:
                ...
                switch ((Dungeon)Rand.Next(dungeonDoors.Count))
                {
                    case Dungeon.Botw:
                    case Dungeon.IceCavern:
                    case Dungeon.DekuTree:
                    case Dungeon.DodongoCavern:
                    case Dungeon.Jabu:
                        return CreateBingoItem("I Broke Sorry");
                    case Dungeon.Forest:
